...
-- Records of activity
-- ----------------------------
INSERT INTO `activity` VALUES (1, '宠物比赛', '欢迎参加宠物大比拼！！！', '2023-07-22 22:49:24', 'http://localhost:9090/file/d99ce4c694034be9867b3dff04b6de01.png', 100, '安徽蚌埠');
...
-- ----------------------------
INSERT INTO `applcation` VALUES (1, 'IT教程资源', '男', 28, '有经验', NULL, '13622914569', '未婚', '5000', '软件开发', '安徽合肥', '我喜欢', '审核通过', 6, 1);
INSERT INTO `applcation` VALUES (2, '爱心人士小李', '男', 25, '有经验', NULL, '17638166578', '未婚', '20000', '程序员', '安徽蚌埠', '喜欢小动物,希望能领养做个伴', '待审核', 3, 5);
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (1, '日常须知', '爱护动物，人人有责', '2023-07-21 23:38:20');
